    ...
    <section class="invoice">
        ...
        <div class="row">
            ...
            <h2 class="page-header">
                <img src="/ecommerce/res/site/img/mixpreco.gif" alt="Logo">
        ...
        <div class="row invoice-info">
            ...
            De
            <address>
                <strong>Mixpreço</strong><br>
                Rua Ademar Saraiva Leão, 234 - Ipsep<br>
                São Bernardo do Campo - PE<br>
                Telefone: (81) 3271-3080<br>
                E-mail: suporte@mixpreco.com.br
            </address>
            </div>
            <!-- /.col -->
            <div class="col-sm-4 invoice-col">
            ...
            <br>
            <b>Emitido em:</b> <?php echo formatData($order["dtregister"]); ?><br>
            <b>Pago em:</b> <?php echo formatData($order["dtregister"]); ?>
        ...
        <div class="row no-print">
            <div class="col-xs-12">
                ...
                <button type="button" onclick="window.open('/ecommerce/boleto/<?php echo htmlspecialchars( $order["idstatus"], ENT_COMPAT, 'UTF-8', FALSE ); ?>')" class="btn btn-default pull-left" style="margin-left: 5px;">
