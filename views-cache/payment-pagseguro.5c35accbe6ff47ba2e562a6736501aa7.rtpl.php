<?php if(!class_exists('Rain\Tpl')){exit;}?><form method="post" action="https://pagseguro.uol.com.br/v2/checkout/payment.html">  
        ...
        <!-- Campos obrigatórios -->  
        <input name="receiverEmail" type="hidden" value="inaciocfilho@gmail.com">  
        ...
        <input name="shippingAddressPostalCode" type="hidden" value="<?php echo utf8_encode($order["deszipcode"]); ?>">  
