        ...
        <form role="form" action="/ecommerce/admin/products/create" method="post">
          <div class="box-body">
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control" id="desurl" name="desurl" placeholder="https://www.mixpreco.com.br">
            </div>

            <div class="form-group">
              <label for="descricaoprod">Descrição do produto</label>
              <textarea class="form-control" id="descricaoprod" name="descricaoprod" value="descricaoprod">
