            ...
            <div class="row">
                ...
                <div class="col-md-3 col-sm-6">
                    <div class="footer-menu">
                        ...
                        <ul>
                            <li><a href="/ecommerce/profile">Minha Conta</a></li>
                            <li><a href="/ecommerce/profile/orders">Meus Pedidos</a></li>
    ...
    <div class="footer-bottom-area">
        <div class="container">
            <div class="row">
                <div class="col-md-8">
                    <div class="copyright">
                        <p>&copy; 2017 mixpreços variedades. <a href="http://www.hcode.com.br" target="_blank">mixpreco.com.br</a></p>
                    </div>
                </div>
