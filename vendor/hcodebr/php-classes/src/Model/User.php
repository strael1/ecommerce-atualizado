...
// define("SECRET", pack("a16","Mixpreco"));
// define("SECRET_IV", pack("a16","Mixpreco"));
...
class User extends Model {
         ...
         if(count($results2) === 0){
            ...
            $code = openssl_encrypt($dataRecovery['idrecovery'], 'AES-128-CBC', pack("a16", User::SECRET), 0, pack("a16", User::SECRET_IV));
             ...
             if($inadmin === true){
               ...
               // ROOT: mixpreco.com.br/admin/forgot/reset?code=$code;
               // ROOT: mixpreco.com.br/forgot/reset?code=$code;

               $link = "localhost:8080/ecommerce/admin/forgot/reset?code=$code";
             
             }else {
               $link = "localhost:8080/ecommerce/forgot/reset?code=$code";

             }

             $mailer = new Mailer($data["desemail"], $data["desperson"],"Redifinir senha da loja mixpreco","forgot", array(
                "name" => $data["desperson"],
                "link" => $link
             ));
   ...
   public static function setForgotUsed($idrecovery){
     ...
     $sql->query("UPDATE tb_userspasswordsrecoveries SET idrecovery = NOW() WHERE idrecovery = :idrecovery", array(
       ":idrecovery" => $idrecovery
     ));
   ...
   // Erro no registro, se caso sim estore na tela
   ...
   // Este método checa se o usuário existe dentro do banco
   ...
   // Método que mostra o que o usuário comprou
